...
sudo -u postgres psql yand -c "copy (select flats.id, flats.full_sq, flats.kitchen_sq, flats.life_sq, flats.floor, flats.is_apartment, flats.building_id, flats.created_at, flats.updated_at, flats.offer_id, flats.closed, flats.rooms_total, flats.image, flats.resource_id, flats.flat_type, flats.is_rented, flats.rent_quarter, flats.rent_year, flats.agency, flats.renovation_type, flats.windows_view from flats, buildings, districts where flats.building_id = buildings.id and buildings.district_id = districts.id and districts.city_id = 1) to STDOUT With CSV DELIMITER ',';" > /home/realtyai/smartrealty/data/flats.csv
...
sudo -u postgres psql yand -c "copy (select flats.id, flats.full_sq, flats.kitchen_sq, flats.life_sq, flats.floor, flats.is_apartment, flats.building_id, flats.created_at, flats.updated_at, flats.offer_id, flats.closed, flats.rooms_total, flats.image, flats.resource_id, flats.flat_type, flats.is_rented, flats.rent_quarter, flats.rent_year, flats.agency, flats.renovation_type, flats.windows_view from flats, buildings, districts where flats.building_id = buildings.id and buildings.district_id = districts.id and districts.city_id = 2) to STDOUT With CSV DELIMITER ',';" > /home/realtyai/smartrealty/data_spb/flats.csv
