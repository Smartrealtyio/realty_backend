            ...
            for idx_flats, i in enumerate(flats):
                ...
                if rooms == 's' and not max_revenue_s:
                    ...
                    if len(sales_value_studio) != 0:
                        if max_flats_count_s - sales_value_studio_acc >= 0 and sales_value_studio[-1] <= max_flats_count_s - sales_value_studio_acc:
                ...
                if rooms == 1 and not max_revenue_1:
                    ...
                    if len(sales_value_1) != 0:
                        if max_flats_count_1 - sales_value_1_acc >= 0 and sales_value_1[-1] <= max_flats_count_1 - sales_value_1_acc:
                ...
                if rooms == 2 and not max_revenue_2:
                    ...
                    if len(sales_value_2) != 0:
                        if max_flats_count_2 - sales_value_2_acc >= 0 and sales_value_2[-1] <= max_flats_count_2 - sales_value_2_acc:
                ...
                if rooms == 3 and not max_revenue_3:
                    ...
                    if len(sales_value_3) != 0:
                        if max_flats_count_3 - sales_value_3_acc >= 0 and sales_value_3[-1] <= max_flats_count_3 - sales_value_3_acc:
                ...
                if rooms == 4 and not max_revenue_4:
                    ...
                    if len(sales_value_4) != 0:
                        if max_flats_count_4 - sales_value_4_acc >= 0 and sales_value_4[-1] <= max_flats_count_4 - sales_value_4_acc:
