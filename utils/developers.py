            ...
            for idx_flats, i in enumerate(flats):
                ...
                if rooms == 's':
                    ...
                    if flats_count > 0:
                        ...
                        sales_value_s = round((prob * flats_count)* sales_volume_coeff_s) if (prob < 1 and flats_count < val)  else val*prob
                ...
                if rooms == 1:
                    ...
                    if flats_count > 0:
                        prob, val = self.calculate_sales_volume_previos_year(full_sq_group=full_sq_group,
                                                                             ...
                                                                             rooms=1,
                                                                             housing_class=housing_class)
                        sales_value_1roomed = round((prob * flats_count)* sales_volume_coeff_1) if (prob < 1 and flats_count < val)  else val*prob
                ...
                if rooms == 2:
                    ...
                    if flats_count > 0:
                        prob, val = self.calculate_sales_volume_previos_year(full_sq_group=full_sq_group,
                                                                             ...
                                                                             rooms=2,
                                                                             housing_class=housing_class)
                        sales_value_2roomed = round((prob * flats_count)* sales_volume_coeff_2) if (prob < 1 and flats_count < val)  else val*prob
                        print('flats_count: ', flats_count)
                        print(
                ...
                if rooms == 3:
                    ...
                    if flats_count > 0:
                        prob, val = self.calculate_sales_volume_previos_year(full_sq_group=full_sq_group,
                                                                             ...
                                                                             rooms=3,
                                                                             housing_class=housing_class)
                        sales_value_3roomed = round((prob * flats_count)* sales_volume_coeff_3) if (prob < 1 and flats_count < val) else val*prob
                        print(
                ...
                if rooms == 4:
                    ...
                    if flats_count > 0:
                        prob, val = self.calculate_sales_volume_previos_year(full_sq_group=full_sq_group,
                                                                             ...
                                                                             rooms=4,
                                                                             housing_class=housing_class)
                        sales_value_4roomed = round((prob * flats_count)* sales_volume_coeff_4) if (prob < 1 and flats_count < val)  else val*prob
                        print(
