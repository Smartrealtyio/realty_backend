...
def main_processing():
    ...
    flats = pd.read_csv(raw_data + "flats.csv", names = ['id','full_sq','kitchen_sq','life_sq','floor','is_apartment','building_id','created_at',
    ...
    buildings = pd.read_csv(raw_data + "buildings.csv", names=["id",
        "max_floor", 'building_type_str', "built_year", "flats_count",
        "address", "renovation", "has_elevator", 'longitude', 'latitude', "district_id", 'created_at', 'updated_at'],
    ...
    ds = ds.drop(['max_floor', 'life_sq','rooms', 'built_year', "flat_id", 'floor', 'id_building', 'district_id', 'transport_type',
