...
class MainPreprocessing():
    ...
    def train_price_model(self, data: pd.DataFrame):
        ...
        df = df[['price', 'full_sq', 'kitchen_sq', 'life_sq', 'is_apartment',
                 'renovation', 'has_elevator', 'time_to_metro', 'floor_first', 'floor_last', 'is_rented', 'rent_quarter',
                 'rent_year', 'to_center', 'was_opened', 'mm_announce__1', 'mm_announce__2', 'mm_announce__3',
                 'mm_announce__4', 'mm_announce__5', 'mm_announce__6', 'mm_announce__7', 'mm_announce__8',
                 'mm_announce__9', 'mm_announce__10', 'mm_announce__11', 'mm_announce__12', 'rooms__0', 'rooms__1',
                 'rooms__2', 'rooms__3', 'rooms__4', 'rooms__5', 'rooms__6', 'yyyy_announce__18', 'yyyy_announce__19',
                 'yyyy_announce__20', 'cluster__0', 'cluster__1',
