...
def map():
    ...
    kmeans = KMeans(n_clusters=180, random_state=42).fit(data[['renovation', 'has_elevator',  'longitude','latitude','floor_last', 'floor_first','price_meter_sq']])
    current_label = kmeans.predict([[renovation, has_elevator, longitude, latitude, floor_last, floor_first, price_meter_sq]])
